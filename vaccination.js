const VACCINE_SCHEDULE = [
  { id: 'hib_1',       name: 'ヒブ（Hib）1回目',        startMonths: 2,  endMonths: 7  },
  ...
  { id: 'dptipv_1',    name: '4種混合（DPT-IPV）1回目',  startMonths: 3,  endMonths: 12 },
  { id: 'hib_2',       name: 'ヒブ（Hib）2回目',         startMonths: 3,  endMonths: 8  },
  ...
  { id: 'dptipv_2',    name: '4種混合（DPT-IPV）2回目',  startMonths: 4,  endMonths: 12 },
  { id: 'hib_3',       name: 'ヒブ（Hib）3回目',         startMonths: 4,  endMonths: 7  },
  { id: 'pcv_3',       name: '肺炎球菌 3回目',            startMonths: 4,  endMonths: 7  },
  { id: 'rota_3',      name: 'ロタウイルス 3回目（5価）',startMonths: 4,  endMonths: 8  },
  { id: 'dptipv_3',    name: '4種混合（DPT-IPV）3回目',  startMonths: 5,  endMonths: 12 },
  { id: 'bcg',         name: 'BCG',                       startMonths: 5,  endMonths: 8  },
  { id: 'hepb_3',      name: 'B型肝炎 3回目',             startMonths: 7,  endMonths: 9  },
  { id: 'hib_4',       name: 'ヒブ（Hib）追加接種',      startMonths: 12, endMonths: 18 },
  ...
  { id: 'dptipv_4',    name: '4種混合（DPT-IPV）追加',   startMonths: 18, endMonths: 24 },
